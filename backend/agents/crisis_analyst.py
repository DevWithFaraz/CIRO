...
from services.gemini_service import parse_gemini_json, client
from utils import log_step, log_agent_trace, update_session
...
"""
    ...
    try:
        ...
        update_session(session_id, {"situation_report": situation_report})
